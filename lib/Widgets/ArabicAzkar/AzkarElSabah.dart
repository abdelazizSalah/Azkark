...
class AzkarElSabah extends StatelessWidget {
  List<Map<String, Object>> azkary = [
    ...
    },
    {
      ...
      'initial': 100,
      'fadl':
          'كتبت له مائة حسنة، ومُحيت عنه مائة سيئة، وكانت له حرزاً من الشيطان حتى يمسى.',
      'title': '',
    },
  ];
  final darkMode;
  ...
  AzkarElSabah({required this.darkMode, required this.darkModeSetter});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AzkarContainer(darkMood: darkMode, azkary: azkary),
    );
  }
}
